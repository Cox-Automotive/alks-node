...
exports.createLongTermKey = function(account, password, iamUserName, opts, callback){
    var payload = _.extend({
        password: password,
        account: account.alksAccount,
        role: account.alksRole,
...
exports.createIamTrustRole = function(account, password, roleName, roleType, trustArn, opts, callback){
    var payload = _.extend({
        password: password,
        account: account.alksAccount,
        role: account.alksRole,
...
exports.deleteLongTermKey = function(account, password, iamUserName, opts, callback){
    var payload = _.extend({
        password: password,
        account: account.alksAccount,
        role: account.alksRole,
...
exports.twoFAToAccessToken = function(account, token, opts, callback){
    var payload = _.extend({
        account: account.alksAccount,
        refreshToken: token
    }, account),
    ...
    log('api:twoFAToAccessToken', 'exchanging 2fa token for access token at endpoint: ' + endpoint, options);
    log('api:twoFAToAccessToken', 'with data: ' + JSON.stringify(sanitizeData(payload), null, 4), options);
