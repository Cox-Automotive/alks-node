...
exports.createIamTrustRole = function(account, password, roleName, roleType, trustArn, opts, callback){
    ...
    log('api:createNonServiceRole', 'creating IAM trust role at endpoint: ' + endpoint, options);
    log('api:createNonServiceRole', 'with data: ' + JSON.stringify(sanitizeData(payload), null, 4), options);
